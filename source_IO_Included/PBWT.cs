...
namespace HP_PBWT
{
    public class PBWT
    {
        ...
        public class Pal
        {
            ...
            public void coreD_ArrV2(utl.RoundTableReaderV2.HapMap map)
            {
            ...
            public void coreD_Arr_skip(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
                ...
                Parallel.For(0, Program.nThread, (i) =>
                {
                    ...
                    else
                    {
                        ...
                        if (oldPDA.pArr[e - 1] != oldPDA.pArr[s - 1])
                        {
                            #region has one
                            minDZ[i] = blockHasOneSignal;
                            minDZ_Ready[i] = true;
                            ...
                            {
                                int seekIndex = s - 1;
                                //jump to the first upper block not pure zero (has one)
                                int seekBlk = i - 1;


                                //while (seekBlk >0 && psHolder[seekBlk * blockSize - 1] == psHolder[(seekBlk + 1) * blockSize - 1])
                                //{
                                //    seekBlk--;
                                //}

                                ////bottom up, take min D from all 0s until 1 appear
                                //seekIndex = (seekBlk + 1) * blockSize - 1;
                                ...
                                while (seekIndex >= 0 && map.Get_HapVal(oldPDA.pArr[seekIndex]) == '0')
                                {
                                    prvLowM_Zero = Math.Min(prvLowM_Zero, oldPDA.mLens[oldPDA.pArr[seekIndex]]);
                                    seekIndex--;
                                }


                                //seekBlk = i - 1;
                                ////wait for the whole 0 block to get mins
                                //while (true)
                                //{
                                //    if (minDZ_Ready[seekBlk] == false)
                                //    {//not ready
                                ...
                                //    if (minDZ[seekBlk] != blockHasOneSignal)
                                //    {
                                //        prvLowM_Zero = Math.Min(minDZ[seekBlk], prvLowM_Zero);
                                //        seekBlk--;
                                //    }
                                //    else
                                //    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                while (seekIndex >= 0 && map.Get_HapVal(oldPDA.pArr[seekIndex]) != '0')
                                {
                                    prvLowM_One = Math.Min(prvLowM_One, oldPDA.mLens[oldPDA.pArr[seekIndex]]);
                                    seekIndex--;
                                }
                            ...
                            minDZ[i] = oldPDA.mLens[hID];
                            for (int j = s + 1; j < e; j++)
                            {
                                hID = oldPDA.pArr[j];
                                newPDA.mLens[hID] = oldPDA.mLens[hID] + 1;
                                minDZ[i] = Math.Min(minDZ[i], oldPDA.mLens[hID]);
                            }
                            minDZ_Ready[i] = true;
                            #endregion
            ...
            public void coreD_Arr_BU_s1(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
                    ...
                    else
                    {
                        ...
                        if (minOneSearch)
                        {
                            ...
                            while (true)
                            {
                                ...
                                if (minDZ[seekBlk] != blockHasOneSignal)
                                {
                                    prvLowM_One = Math.Min(minDZ[seekBlk], prvLowM_One);
                                    seekBlk--;
                                }
                                else
                                {
            ...
            public void coreD_Arr_BU_s1a(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
            ...
            public void coreD_Arr_s1b(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
            ...
            public void coreD_Arr_s1c(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
            ...
            public void coreD_Arr_s2a(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
                ...
                Parallel.For(0, Program.nThread, (i) =>
                {
                    ...
                    else
                    {
                        ...
                        if (minZeroSearch)
                        {
                            ...
                            //vvvvvvvvvv old method this could take long//
                            prvLowM_Zero = oldPDA.mLens[oldPDA.pArr[seekIndex]];
                            while (seekIndex >= 0 && map.Get_HapVal(oldPDA.pArr[seekIndex]) == '0')
                            {
                                prvLowM_Zero = Math.Min(oldPDA.mLens[oldPDA.pArr[seekIndex]], prvLowM_Zero);
                            ...
                            //^^^^^^^^^^ old method this could take long//
            ...
            public void coreD_Arr_s2b(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
                ...
                Parallel.For(0, Program.nThread, (i) =>
                {
                    ...
                    else
                    {
                        ...
                        if (minZeroSearch)
                        {
                            ...
                            while (true)
                            {
                                while (minDZ_Ready[blk_ID] == false)
                                {
                                    continue;
                                }
                                if (minDZ[blk_ID] == blockHasOneSignal)
                                {
                                    break;
                                }
            ...
            public void coreD_Arr_s2c(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
            ...
            public void coreD_Arr_s3a(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
                ...
                Parallel.For(0, Program.nThread, (i) =>
                {
                    ...
                    else
                    {
                        ...
                        if (minZeroSearch)
                        {
                            ...
                            while (blk_ID > 0)
                            {
                                //if ((blk_ID==0) ||(psHolder[blk_ID * blockSize - 1] != psHolder[(blk_ID+1) * blockSize - 1]))
                                //{
                                //    break;
                                //}
                                ...
                                if (minDZ[blk_ID] == blockHasOneSignal)
                                {
                                    //int a = psHolder[blk_ID * blockSize - 1];
                                    //int b = psHolder[(blk_ID + 1) * blockSize - 1];
                                    //if (a == b)
                                    //{
                                    //    int abc = 0;
                                    //}
            ...
            public void coreD_Arr_s3b(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
            ...
            public void coreD_Arr_BU(utl.RoundTableReaderV2.HapMap map)
            {
                ResetMinDZ();
                ...
                Parallel.For(0, Program.nThread, (i) =>
                {
                    ...
                    if (s == 0)
                    {
                        ...
                        if (oldPDA.pArr[e - 1] != 0)
                        {
                            ...
                            if (map.Get_HapVal(oldPDA.pArr[e - 1]) == '0')
                            {
                                prvLowM_One = int.MaxValue;
                            }
                            else
                            {
                                prvLowM_Zero = int.MinValue;
                            }
                            ...
                            for (int k = e - 2; k > 0; k--)
                            {
                                ...
                                hID = oldPDA.pArr[k];
                                hID_Down = oldPDA.pArr[k + 1];
                                //incoming is 0
                                if (map.Get_HapVal(hID) == '0')
                                {
                                    newPDA.mLens[hID_Down] = Math.Min(oldPDA.mLens[hID_Down], prvLowM_One) + 1;
                                    prvLowM_One = int.MaxValue;
                                    prvLowM_Zero = Math.Min(prvLowM_Zero, oldPDA.mLens[hID_Down]);
                                }
                                else//incoming is 1
                                {
                                    newPDA.mLens[hID_Down] = Math.Min(oldPDA.mLens[hID_Down], prvLowM_Zero) + 1;
                                    prvLowM_Zero = int.MaxValue;
                                    prvLowM_One = Math.Min(prvLowM_One, oldPDA.mLens[hID_Down]);
                                }
                            }
                        ...
                        #region does not have 1
                        for (int k = e - 1; k > 0; k--)
                        {
                            newPDA.mLens[oldPDA.pArr[k]]++;
                        }
                        #endregion
                        newPDA.mLens[oldPDA.pArr[0]] = 0;
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            for (int j = s; j < e; j++)
                            {
                                minDZ[i] = Math.Max(minDZ[i], oldPDA.mLens[oldPDA.pArr[j]]);
                                minDZ_Ready[i] = true;
                            }
            ...
            public void ReportLongMatches_SL_Tail(int siteIndex)
            {
                ...
                //Test.Dict_CountCheck(res, GT);
                //Test.Dict_Diff_LongMatch(res, GT);
                //Test.Dict_Diff_LongMatch(GT, res);
            }
            ...
            public void ReportSetMaxMatch(int siteIndex, utl.RoundTableReaderV2.HapMap map)
            {
                ...
                //foreach (int oneChosenIndex in chosens)
                {
                    ...
                    for (int i = rangeUp; i <= rangeDown; i++)
                    {
                        ...
                        //Program.outWriter.WriteLineAsync(currHID + "\t" + oldPDA.pArr[i] + "\t" + siteIndex + " " + len);
            ...
            public void OneSort(utl.RoundTableReaderV2.HapMap map, int doneIndex)
            {
                ...
                //coreD_Arr_LowMAF(map,doneIndex);
                //coreD_Arr_skip(map);
                //coreD_Arr_s3b(map);
